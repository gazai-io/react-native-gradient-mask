...
assert(EdgeMaskGeometry.containsTouch(125, top: 0.25, bottom: 0.75, container: 400, topRatio: true, bottomRatio: true))
assert(!EdgeMaskGeometry.containsTouch(325, top: 0.25, bottom: 0.75, container: 400, topRatio: true, bottomRatio: true))
assert(!EdgeMaskGeometry.containsTouch(125, top: 200, bottom: 600, container: 400))
assert(EdgeMaskGeometry.containsTouch(325, top: 200, bottom: 600, container: 400))
print("Percentage boundary touch assertions passed")
