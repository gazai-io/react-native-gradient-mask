...
type Keys = 'top' | 'bottom' | 'topFeather' | 'bottomFeather' | 'enabled';
...
export default function AnimatedViewportMaskView({top, bottom, topFeather, bottomFeather, enabled, ...viewProps}: AnimatedViewportMaskViewProps) {
