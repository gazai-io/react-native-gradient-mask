...
export default function GradientMaskView(props: GradientMaskViewProps) {
  ...
  const maskStyle = buildMaskStyle({ direction, maskOpacity, topMaskHeight, bottomMaskHeight,
    topMaskEnabled, bottomMaskEnabled, topMaskOpacity, bottomMaskOpacity }, gradient.colors, gradient.locations, height);
