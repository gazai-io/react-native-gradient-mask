...
export default function ViewportMaskView({ top, bottom, topFeather, bottomFeather, enabled, ...viewProps }: ViewportMaskViewProps) {
  return <NativeView {...viewProps} {...viewportMaskProps({top, bottom, topFeather, bottomFeather, enabled})} />;
}
